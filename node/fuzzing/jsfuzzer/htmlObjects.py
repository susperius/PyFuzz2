...
#  #  #  #  #  #  #  #  #  #  #  #  #  #  # HTML5 #  #  #  #  #  #  #  #  #  #  #  #  #  #  #  #  #  #  #  #  #  #  #  #
    ...
    HTML5_GLOBAL_ATTR = {'accesskey': 'CHAR', 'class': 'CSS_CLASS', 'contenteditable': 'BOOL', # 'contextmenu': 'MENU',
                         #'data-': 'APP_DATA',
                         'dir': 'DIRECTION', 'dragable': 'BOOL', 'hidden': 'BOOL',
                         #'id': 'ID',
    ...
    HTML5_OBJECTS = {'a': {'outer_tag': None, 'attr': dict(HTML5_A_ATTR.items() + HTML5_GLOBAL_ATTR.items()), 'req_attr': ['href']},
                     ...
                     'base': {'outer_tag': ['head'], 'attr': dict(HTML5_BASE_ATTR.items() + HTML5_GLOBAL_ATTR.items()), 'req_attr': ['href']},
                     #'bdi': ,
                     'bdo': {'outer_tag': None, 'attr': HTML5_GLOBAL_ATTR, 'req_attr': ['dir']},
                     'blockquote': {'outer_tag': None, 'attr': dict(HTML5_BLOCKQOUTE_ATTR.items() + HTML5_GLOBAL_ATTR.items()), 'req_attr': ['cite']},
                     ...
                     'col': {'outer_tag': ['colgroup'], 'attr': dict(HTML5_COL_ATTR.items() + HTML5_GLOBAL_ATTR.items()), 'req_attr': ['span']},
                     'colgroup': {'outer_tag': ['table'], 'attr': dict(HTML5_COL_ATTR.items() + HTML5_GLOBAL_ATTR.items()), 'req_attr': None},
                     'datalist': {'outer_tag': None, 'attr': HTML5_GLOBAL_ATTR, 'req_attr': None},
                     'dd': {'outer_tag': ['dl'], 'attr': HTML5_GLOBAL_ATTR, 'req_attr': None},
                     'del': {'outer_tag': None, 'attr': HTML5_GLOBAL_ATTR, 'req_attr': ['cite']},
                     'details': {'outer_tag': None, 'attr': dict(HTML5_DETAILS_ATTR.items() + HTML5_GLOBAL_ATTR.items()), 'req_attr': ['open']},
                     'dfn': {'outer_tag': None, 'attr': HTML5_GLOBAL_ATTR, 'req_attr': None},
                     'dialog': {'outer_tag': None, 'attr': dict(HTML5_DETAILS_ATTR.items() + HTML5_GLOBAL_ATTR.items()), 'req_attr': ['open']},
                     #'dir':,
                     ...
                     'header': {'outer_tag': None, 'attr': HTML5_GLOBAL_ATTR, 'req_attr': None},
                     ...
                     'iframe': {'outer_tag': None, 'attr': dict(HTML5_IFRAME_ATTR.items() + HTML5_GLOBAL_ATTR.items()), 'req_attr': ['srcdoc']},
                     'img': {'outer_tag': None, 'attr': dict(HTML5_IMG_ATTR.items() + HTML5_GLOBAL_ATTR.items()), 'req_attr': None},
                     'input': {'outer_tag': None, 'attr': HTML5_GLOBAL_ATTR, 'req_attr': None},
                     'ins': {'outer_tag': None, 'attr': HTML5_GLOBAL_ATTR, 'req_attr': None},
                     'kbd': {'outer_tag': None, 'attr': HTML5_GLOBAL_ATTR, 'req_attr': None},
                     'keygen': {'outer_tag': ['form'], 'attr': dict(HTML5_KEYGEN_ATTR.items() + HTML5_GLOBAL_ATTR.items()), 'req_attr': None},
                     'label': {'outer_tag': ['form'], 'attr': dict(HTML5_LABEL_ATTR.items() + HTML5_GLOBAL_ATTR.items()), 'req_attr': None},
                     'legend': {'outer_tag': ['fieldset'], 'attr': HTML5_GLOBAL_ATTR, 'req_attr': None},
                     'li': {'outer_tag': ['ol' 'ul'], 'attr': dict(HTML5_LI_ATTR.items() + HTML5_GLOBAL_ATTR.items()), 'req_attr': None},
                     ...
                     #'menu':,
                     #'menuitem':,
                     'meta': {'outer_tag': ['head'], 'attr': dict(HTML5_META_ATTR.items() + HTML5_GLOBAL_ATTR.items()), 'req_attr': ['content', 'name']},
                     'meter': {'outer_tag': None, 'attr': dict(HTML5_METER_ATTR.items() + HTML5_GLOBAL_ATTR.items()), 'req_attr': ['value']},
                     'nav': {'outer_tag': None, 'attr': HTML5_GLOBAL_ATTR, 'req_attr': None},
                     #'noframes':,
                     #'noscript':,
                     'object': {'outer_tag': None, 'attr': dict(HTML5_OBJECT_ATTR.items() + HTML5_GLOBAL_ATTR.items()), 'req_attr': None},
                     'ol': {'outer_tag': None, 'attr': HTML5_GLOBAL_ATTR, 'req_attr': None},
                     'optgroup': {'outer_tag': ['select'], 'attr': HTML5_GLOBAL_ATTR, 'req_attr': None},
                     'option': {'outer_tag': ['select', 'optgroup'], 'attr': dict(HTML5_OPTION_ATTR.items() + HTML5_GLOBAL_ATTR.items()), 'req_attr': None },
                     ...
                     'progress': {'outer_tag': None, 'attr': dict(HTML5_PROGRESS_ATTR.items() + HTML5_GLOBAL_ATTR.items()), 'req_attr': ['max', 'value']},
                     ...
                     'source': {'outer_tag': ['audio', 'video'], 'attr': dict(HTML5_SOURCE_ATTR.items() + HTML5_GLOBAL_ATTR.items()), 'req_attr': None},
                     ...
                     'textarea': {'outer_tag': None, 'attr': dict(HTML5_TEXTAREA_ATTR.items() + HTML5_GLOBAL_ATTR.items()), 'req_attr': None},
